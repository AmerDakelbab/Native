        ...
        <View className="flex-1 bg-black">
            ...
            <View className='items-center mt-24'>
                <View className='items-center'>
                    {/* Image */}
                    <View>
                        <Text className='text-white font-inter-bold font-bold text-3xl mb-4'>Front of the card</Text>
                    </View>
                    <Image
                        source={{ uri: photoUri }}
                        style={{
                ...
                <View className='w-9/12'>
                    <Text className='text-white text-center font-inter-bold'>
                        Is the front of your driving license in the frame and easy to read? If so, you’re all good to go!
                    </Text>
                </View>
                </View>
                ...
                <View className="w-fit mx-4">
                    <TouchableOpacity
                        onPress={() => navigation.navigate('BackCameraScreen', { photoUri })}
